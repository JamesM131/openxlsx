...
#' conditionalFormatting(wb, "cellIs", cols = 1,
...
#' conditionalFormatting(wb, "Moving Row", cols = 1:2,
...
#' conditionalFormatting(wb, "Moving Col", cols = 1:2, 
...
#' conditionalFormatting(wb, "Dependent on", cols = 1:2,
#'  rows = 1:11, rule = "$A$1<0", style = negStyle)
#' conditionalFormatting(wb, "Dependent on", cols = 1:2,
#'  rows = 1:11, rule = "$A$1>0", style = posStyle)
#'
...
#' conditionalFormatting(wb, "Dependent on", cols = 1,
...
#' conditionalFormatting(wb, "containsText", cols = 1,
#'  rows = 1:10, type = "contains", rule = "A")
#'
...
#' conditionalFormatting(wb, "databar", cols = 1, 
#' rows = 1:11, type = "databar") ## Default colours
#'
#' ## Betweem
#' # Highlight cells in interval [-2, 2]
#' writeData(wb, "between", -5:5)
#' conditionalFormatting(wb, "between", cols = 1,
#'  rows = 1:11, type = "between", rule = c(-2, 2))
#'
#' ## Logical Operators
...
#' conditionalFormatting(wb, "databar", cols = 1,
#'  rows = 1:11, type = "databar") ## Defaults
#'
#' writeData(wb, "databar", -5:5, startCol = 3)
#' conditionalFormatting(wb, "databar", cols = 3,
#'  rows = 1:11, type = "databar", border = FALSE)
#'
#' writeData(wb, "databar", -5:5, startCol = 5)
#' conditionalFormatting(wb, "databar",
#'   cols = 5, rows = 1:11,
#'   type = "databar", style = c("#a6a6a6"), 
#'   showValue = FALSE
#' )
#'
...
#'   cols = 7, rows = 1:11,
#'   type = "databar", style = c("#a6a6a6"),
#'    showValue = FALSE, gradient = FALSE
#' )
#'
#' writeData(wb, "databar", -5:5, startCol = 9)
#' conditionalFormatting(wb, "databar",
#'   cols = 9, rows = 1:11,
#'   type = "databar", style = c("#a6a6a6", "#a6a6a6"),
#'    showValue = FALSE, gradient = FALSE
#' )
#' \dontrun{
